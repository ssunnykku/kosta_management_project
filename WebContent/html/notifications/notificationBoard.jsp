...
<body id="notification-body">
	...
	<section id="notification-section"> <article
		class="notification-contents"
	>
	...
	<div id="notification-table">
		...
		<c:forEach var="notificationVO" items="${notificationVOs}">
            ...
            <span>${notificationVO.title}</span>
              <%-- <a href="controller?cmd=notificationPostUI&notificationId=${notificationVO.notificationId}">${notificationVO.title}</a> --%>
            </div>
				<div class="notificationBoard-enroll-date">
	...
	<div class="pagenation">
		...
		<div class="page-number">
			<img src="../../assets/double_arrow_right.svg"
	...
	<script type="text/javascript">
		...
		for ( var i in title) {
			title[i].addEventListener('click', function() {
								window.location.href = 'controller?cmd=notificationPostUI&notificationId='
										+ this.dataset["id"];
